...
@router.post("/infer-image", summary='Detect knives in image and return marked image', response_description="Something here")
...
@router.post("/infer-json", summary='Detect knives in image and return json', response_description="Something here")
